		...
		it('should return valid json with a 400 status code for noncommercial POST request without a body', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.response.message).to.equal('Region is a required field. Forest is a required field. District is a required field. Applicant info is a required field. Type is a required field. Noncommercial fields is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a numberParticipants', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.response.message).to.equal('Number participants is a required field.');
		...
		it('should return valid json for invalid type, numberParticipants', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.response.message).to.equal('Number participants is expected to be type \'integer\'. ');
