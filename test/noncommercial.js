		...
		it('should return valid json with a 400 status code for noncommercial POST request without a body', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Region is a required field. Forest is a required field. District is a required field. Applicant Info is a required field. Applicant Info/First Name is a required field. Applicant Info/Last Name is a required field. Applicant Info/Day Phone is a required field. Applicant Info/Day Phone/Area Code is a required field. Applicant Info/Day Phone/Number is a required field. Applicant Info/Day Phone/Phone Type is a required field. Applicant Info/Email Address is a required field. Applicant Info/Mailing Address is a required field. Applicant Info/Mailing City is a required field. Applicant Info/Mailing Zip is a required field. Applicant Info/Mailing State is a required field. Type is a required field. Noncommercial Fields is a required field. Noncommercial Fields/Activity Description is a required field. Noncommercial Fields/Location Description is a required field. Noncommercial Fields/Start Date Time is a required field. Noncommercial Fields/End Date Time is a required field. Noncommercial Fields/Number Participants is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a noncommercialFields object', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields is a required field. Noncommercial Fields/Activity Description is a required field. Noncommercial Fields/Location Description is a required field. Noncommercial Fields/Start Date Time is a required field. Noncommercial Fields/End Date Time is a required field. Noncommercial Fields/Number Participants is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a firstName', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/First Name is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a lastName', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Last Name is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a dayphone', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Day Phone is a required field. Applicant Info/Day Phone/Area Code is a required field. Applicant Info/Day Phone/Number is a required field. Applicant Info/Day Phone/Phone Type is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a dayPhone/areaCode', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Day Phone/Area Code is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a dayPhone/number', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Day Phone/Number is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a dayPhone/phoneType', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Day Phone/Phone Type is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without an emailAddress', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Email Address is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a mailingAddress', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Mailing Address is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a mailingCity', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Mailing City is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a mailingState', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Mailing State is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a mailingZIP', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Mailing Zip is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without an activityDescription', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields/Activity Description is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a locationDescription', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields/Location Description is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a startDateTime', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields/Start Date Time is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a endDateTime', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields/End Date Time is a required field.');
		...
		it('should return valid json with a 400 status code for noncommercial POST request without a numberParticipants', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields/Number Participants is a required field.');
		...
		it('should return valid json for invalid type, firstName', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/First Name is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, lastName', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Last Name is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, dayPhone.areaCode', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Day Phone/Area Code is expected to be type \'integer\'.');
		...
		it('should return valid json for invalid type, dayPhone.number', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Day Phone/Number is expected to be type \'integer\'.');
		...
		it('should return valid json for invalid type, dayPhone.phoneType', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Day Phone/Phone Type is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, emailAddress', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Email Address is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, mailingAddress', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Mailing Address is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, mailingCity', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Mailing City is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, mailingState', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Mailing State is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, mailingZIP', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Mailing Zip is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, activityDescription', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields/Activity Description is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, locationDescription', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields/Location Description is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, startDateTime', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields/Start Date Time is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, endDateTime', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields/End Date Time is expected to be type \'string\'.');
		...
		it('should return valid json for invalid type, numberParticipants', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Noncommercial Fields/Number Participants is expected to be type \'integer\'.');
		...
		it('should return valid json for invalid type, dayPhone.extension', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Day Phone/Extension is expected to be type \'string\'.');
		...
		it('should return valid json for invalid format, areaCode', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Day Phone/Area Code must be 3 digits.');
		...
		it('should return valid json for invalid format, number', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Day Phone/Number must be 7 digits.');
	...
	it('should return valid json for invalid format, mailingState', function(done) {
		...
		request(server)
			...
			.expect(function(res){
				...
				expect(res.body.message).to.equal('Applicant Info/Mailing State must be 2 letters.');
	...
	it('should return valid json for invalid format, mailingZIP', function(done) {
		...
		request(server)
			...
			.expect(function(res){
				...
				expect(res.body.message).to.equal('Applicant Info/Mailing Zip must be 5 or 9 digits.');
	...
	it('should return valid json for invalid format, region', function(done) {
		...
		request(server)
			...
			.expect(function(res){
				...
				expect(res.body.message).to.equal('Region must be 2 digits.');
	...
	it('should return valid json for invalid format, forest', function(done) {
		...
		request(server)
			...
			.expect(function(res){
				...
				expect(res.body.message).to.equal('Forest must be 2 digits.');
	...
	it('should return valid json for invalid format, district', function(done) {
		...
		request(server)
			...
			.expect(function(res){
				...
				expect(res.body.message).to.equal('District must be 2 digits.');
	...
	it('should return valid json for invalid format, startDateTime', function(done) {
		...
		request(server)
			...
			.expect(function(res){
				...
				expect(res.body.message).to.equal('Noncommercial Fields/Start Date Time must be in format \'YYYY-MM-DDThh:mm:ssZ\'.');
	...
	it('should return valid json for invalid format, endDateTime', function(done) {
		...
		request(server)
			...
			.expect(function(res){
				...
				expect(res.body.message).to.equal('Noncommercial Fields/End Date Time must be in format \'YYYY-MM-DDThh:mm:ssZ\'.');
		...
		it('should return valid json for invalid option, type', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Type is not one of enum values: noncommercial,tempOutfitters.');
		...
		it('should return valid json for invalid option, orgType', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Org Type is not one of enum values: Individual,Corporation,Limited Liability Company,Partnership or Association,State Government or Agency,Local Government or Agency,Nonprofit.');
		...
		it('should return valid json for invalid pattern, emailAddress', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Applicant Info/Email Address must be in format \'email@email.service\'.');
		...
		it('should return valid json for organizationName being provided but not orgType', function(done) {
			...
			request(server)
				...
				.expect(function(res){
					...
					expect(res.body.message).to.equal('Having Applicant Info/Organization Name requires that Applicant Info/Org Type be provided.');
